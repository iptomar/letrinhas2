      ...
      function processarDados() {
        return function(errx, response) {
          ...
          for (var i = 0; i < response.rows.length; i++) {
            ...
            testes_local2.get(resolucoes.key.id_Teste, function(err, testeDoc) {
              ...
              perguntas_local2.get(testeDoc.perguntas[0], function(err, perguntasDoc) {
                if (err) console.log(err);
                console.log(perguntasDoc.tipoTeste);
                ...
                alunos_local2.getAttachment(resolucoes.key.id_Aluno, 'aluno.png', function(err2, DataImg) {
                  ...
                  alunos_local2.get(resolucoes.key.id_Aluno, function(err, alunoDoc) {
                    ...
                    var $btn = $(
                      '<div class="col-sm-20">' +
                      '<button id="' + resolucoes.key._id + '" value="' + resolucoes.key.tipoCorrecao + '" type="button"' +
